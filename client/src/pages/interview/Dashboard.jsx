      ...
      >
        ...
        {mockInterviews.length === 0 ? (
          <p className="text-gray-600 dark:text-gray-300">
            You have not created any mock interviews yet.
          </p>
        ) : (
            ...
            {mockInterviews.map((interview) => (
              ...
              >
                ...
                <div className="flex justify-center gap-4 mt-4">
                  <motion.button
                    className="relative px-6 py-3 font-semibold text-white bg-gradient-to-r from-blue-600 to-blue-800 rounded-lg shadow-lg hover:from-blue-700 hover:to-blue-900 transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-2xl focus:ring focus:ring-blue-400"
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 0.95 }}
                    onClick={() =>
                      navigate(`/mockInterview/${interview.mockId}/feedback`)
                    }
                  >
                    Feedback
                  ...
                  <motion.button
                    className="relative px-6 py-3 font-semibold text-white bg-gradient-to-r from-purple-600 to-purple-800 rounded-lg shadow-lg hover:from-purple-700 hover:to-purple-900 transition-all duration-300 ease-in-out transform hover:scale-105 focus:ring focus:ring-purple-400"
                    onClick={() =>
                      navigate(
                        `/mockinterview/startInterview/${interview.mockId}`
                      )
                    }
                  >
                    Start
